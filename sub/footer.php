    ...
    <div class="px-4 text-center">
        <div class="col-12 align-content-center">
            ...
            <ul class="nav justify-content-center footer-nav border-bottom pb-3 mb-3">
                ...
                <li class="ms-0"><a href="mailto:health@nefb.org"><i class="bi bi-envelope-fill" style="font-size: 1.25rem;"></i></a></li>
            </ul>
            <p class="text-muted" style="margin: 30px 0; font-size: 15px;">
                &copy; <?php echo date("Y");?> Nebraska Farm Bureau Health Plans. All Rights Reserved.
            </p>
        </div>
    </div>
</footer>