...
<main class="container">
    ...
    <div class="row gx-5">
        ...
        <div class="col-lg-6 col-sm-12">
            <hr>
            <h4>General Medical Request Form</h4>
    ...
    <div class="row gx-5">
        ...
        <div class="col-lg-6 col-sm-12">
            ...
            <p>This resource explains the grievance procedure used by Kansas Farm Bureau Health Plans. If you would like to file a grievance, please use <a href="#" target="_blank">this form</a>.</p>
            <button type="button" class="btn btn-primary">
                <a href="#" target="_blank">Download</a>
            </button>
        </div>
        ...
        <div class="col-lg-6 col-sm-12">
            <hr>
            <h4>Bank Draft Authorization Form (Over 65)</h4>
        ...
        <div class="col-lg-6 col-sm-12">
            <hr>
            <h4>Change Form for Members Over 65</h4>
        ...
        <div class="col-lg-6 col-sm-12">
            <hr>
            <h4>Cancellation Form for Members Over 65</h4>
