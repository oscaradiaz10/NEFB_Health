                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            ...
                            <ul>
                                <li>Screenings and counseling services with <a href="https://www.uspreventiveservicestaskforce.org/uspstf/topic_search_results?topic_status=P" target="_blank">an A or B recommendation</a> by the <a href="http://www.uspreventiveservicestaskforce.org/" target="_blank">States Preventative Services Task Force (USPSTF)</a></li>
                                <li>Bright Futures recommendations for infants, children and adolescents supported by the Health Resources and Services Administration (HRSA)</li>
                                <li>Preventative care and screening for women as provided in the guidelines supported by HRSA, and Immunizations recommended by the Advisory Committee of Immunization Practices (ACIP) that have been adopted by the Centers for Disease Control and Prevention (CDC)</li>
                            </ul>
